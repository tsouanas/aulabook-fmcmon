...
\newtheorem {question}  [exercise]  {Problema}   
\theoremstyle{plain}
\newtheorem {theorem}   [exercise]  {Teorema}   
\newtheorem {lemma}     [exercise]  {Lema}     
...
\def\iffdf{\mathrel{{\buildrel{\text{def}} \over {\iff}}}}
\def\iffpseudodf{\mathrel{{\buildrel{\text{``def''}} \over {\iff}}}}
\def\iffask{\mathrel{{\buildrel{\text{?}} \over {\iff}}}}
\def\letiff{\mathrel{\;:\Longleftrightarrow \;}}
\def\eqdf{\mathrel{{\buildrel{\text{def}} \over {=}}}}
\def\eqpseudodf{\mathrel{{\buildrel{\text{``def''}} \over {=}}}}
